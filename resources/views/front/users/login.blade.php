                ...
                <div class="col-lg-6 col-md-6 mb-4">
                    <div class="login-area">
                        <div class="tab-content nav">
                            <form id="loginForm" action="javascript:; "class="tab-pane active col-12" method="post">@csrf
                                ...
                                <div class="mb-4">
                                    ...
                                    <input name="password" id="users-password" required="" class="form-control " placeholder="Type Password" type="password">
